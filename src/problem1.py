...
Authors: Every CSSE faculty member, Dr. Brackin, and Steven Kay.
"""
...
# ---------------------------------------------------------------------
    def lose_passengers(self, num_passengers):
        if self.occupants - num_passengers >= 0:
            self.occupants = self.occupants - num_passengers
            return True
        return False
...
def run_test_go_to_floor():
    ...
    print()
    # Test 2:  Sends elevator to 19th floor.
    e1 = Elevator(20, 18)
    expected_capacity = 20
    expected_num_floors = 18
    ...
    print("Expected:", expected_capacity, expected_num_floors, expected_go_to_floor)
    print('Actual: go_to_floor returns :', e1.go_to_floor(19))
    print("Actual:", e1.capacity, e1.num_floors, e1.current_floor)
    print()
...
def run_test_get_passengers():
    ...
    # Test 2:  Adds 22 passengers to an empty elevator.
    e1 = Elevator(20, 18)
    expected_capacity = 20
    expected_num_floors = 18
    ...
    print("Expected:", expected_capacity, expected_num_floors, expected_num_passengers)
    print('Actual passengers returns ', e1.get_passengers(22))
    print("Actual:", e1.capacity, e1.num_floors, e1.occupants)
    print()

    # Test 3:  removes 2 passengers from a full elevator.
    e1 = Elevator(20, 18)
    e1.get_passengers(20)
    expected_capacity = 20
    expected_num_floors = 18
    expected_num_passengers = 18
    print('Expected passengers returns ', True)
    print("Expected:", expected_capacity, expected_num_floors, expected_num_passengers)
    print('Actual passengers returns ', e1.lose_passengers(2))
    print("Actual:", e1.capacity, e1.num_floors, e1.occupants)
    print()
